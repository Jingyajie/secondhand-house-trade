            ...
            <div class="col-md-8">
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="company" class="form-control" id="companyAddress" placeholder="公司门店">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="passID" class="col-sm-2 control-label">执照编号</label>
                        <div class="col-sm-8">
                            <input type="id" class="form-control" id="passID" placeholder="执照编号">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="serviceYear" class="col-sm-2 control-label">服务年限</label>
                        <div class="col-sm-3">
                            <input type="year" class="form-control" id="serviceYear" placeholder="服务年限">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea type="personalText" id="personalIntro" class="form-control" rows="5"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea type="sellText" id="sellHouse" class="form-control" rows="5"></textarea>
                        <#--<input type="traffic" class="form-control" id="inputTraffic" placeholder="">-->
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea type="careerText" id="careerIntro" class="form-control" rows="5"></textarea>
                        <#--<input type="traffic" class="form-control" id="inputTraffic" placeholder="">-->
                        </div>
                    </div>
                </form>
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <button class="btn btn-success btn-small" type="submit">认证信息</button>
                    </div>
                    <div class="col-md-3">
