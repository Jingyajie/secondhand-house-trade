...
<div class="index-container">
    <div class="row index-login-out-row">
        ...
        <#include "modules/load.ftl">
            ...
            <a class="a-text" href="#" data-toggle="modal" data-target="#myModal">&nbsp;登录</a>
            <a class="a-text" href="#" data-toggle="modal" data-target="#myModal1">&nbsp;立即注册</a>
        </div>
    </div>
    <div class="row index-navbar-row">
        <div class="col-md-5">
            <img src="image/house.png" alt="" style="width: 50px" class="index-row">
            <lable class="index-title index-row">易房保</lable>
        </div>
